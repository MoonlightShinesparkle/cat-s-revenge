...
function PawCoinsBag:Destroy()
	if not Objects.Initiated then
		Objects:Init()
	end
	Objects:NewPawCoin(self,self:get_parent():get_parent():get_node("Pickables"))
...
function PawCoinsBag:_input_event(viewport,Event)
